...
// we also need a SinglyLinkedCircularLinkedList class, which will represent the
// list itself. the list will contain functions to add to the head of the list,
// after a given node of the list to the tail of the list, find a node in the
// list, and finally remove a node from the list. We will also include a utility
